<?php get_header(); ?>
	...
	<div class="container contenedor-hts">
			...
			while ($wp_query->have_posts()) : $wp_query->the_post(); ?>
			    ...
			    <?php 
					...
					if( !empty($image) ): ?>
							...
							<div class="col-xs-4 col-sm-4 col-md-3 col-xl-2 img-herramientas">
								<img class=" img-thumbnail imagen" src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
							</div>
				<?php endif; ?>		
			<?php endwhile; ?>
		</div>
